 ...
 * INCLUDE config.php
 */
require_once('/var/www/virtual/dev.sonpo-form.jp/mojavi/webapp/config.php');

define('DEFAULT_MODULE', 'FormManage');
define('DEFAULT_ACTION', 'Index');
define('SCRIPT_PATH', '/manage/forms/index.php');

define('AUTH_MODULE', 'FormManage');
