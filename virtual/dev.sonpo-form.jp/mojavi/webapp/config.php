 ...
 */
define('BASE_DIR', '/var/www/virtual/dev.sonpo-form.jp/mojavi/webapp/');
 ...
 * uses.
 */
define('MOJAVI_FILE', '/var/www/virtual/dev.sonpo-form.jp/mojavi/mojavi/mojavi-all-classes.php');

/**
 * An absolute file-system path to the optional classes directory.
 */
define('OPT_DIR', '/var/www/virtual/dev.sonpo-form.jp/mojavi/mojavi/opt/');
...
define('SQL_USER', 'sonpo');
define('SQL_PASSWORD', '07dpm05');
define('SQL_DATABASE', 'newscms_test'); 
...
//define('SONPO_SITE_URL',      'http://www.sonpo-form.jp');
define('SONPO_SITE_URL',      'http://dev.sonpo-form.jp');

define('SONPO_DOCUMENT_ROOT','/var/www/virtual/dev.sonpo-form.jp/html');

define('SONPO_IMAGE_DIR',      '/var/www/virtual/dev.sonpo-form.jp/html/news/image/');
define('SONPO_FILE_DIR',       '/var/www/virtual/dev.sonpo-form.jp/html/news/file/');
define('SONPO_TEMP_IMAGE_DIR', '/var/www/virtual/dev.sonpo-form.jp/html/news/image/_temp/');

define('SONPO_NEWS_FILE_DIR',    '/var/www/virtual/dev.sonpo-form.jp/html/news/release/');
define('SONPO_NEWINFO_FILE_DIR', '/var/www/virtual/dev.sonpo-form.jp/html/news/new_info/');
define('SONPO_INDEX_FILE_DIR',   '/var/www/virtual/dev.sonpo-form.jp/html/');
define('SONPO_BRANCH_FILE_DIR',  '/var/www/virtual/dev.sonpo-form.jp/html/about/action/branch/');
define('SONPO_PRIZE_FILE_DIR',  '/var/www/virtual/dev.sonpo-form.jp/html/news/application/');
define('SONPO_TOPIC_FILE_DIR',  '/var/www/virtual/dev.sonpo-form.jp/html/news/information/');

define('SONPO_EN_NEWS_FILE_DIR',    '/var/www/virtual/dev.sonpo-form.jp/html/en/news/');
define('SONPO_EN_STATE_FILE_DIR',   '/var/www/virtual/dev.sonpo-form.jp/html/en/statements/');

define('SONPO_TOP_FILE_DIR', '/var/www/virtual/dev.sonpo-form.jp/html/news/list/');
define('SONPO_RSS_FILE_DIR', '/var/www/virtual/dev.sonpo-form.jp/html/rss/');
define('SONPO_EN_RSS_FILE_DIR','/var/www/virtual/dev.sonpo-form.jp/html/en/rss/');
...
define('SONPO_PDF_DIR',      '/var/www/virtual/dev.sonpo-form.jp/contact/pdf/');
define('SONPO_TEMP_PDF_DIR', '/var/www/virtual/dev.sonpo-form.jp/contact/pdf/_temp/');
