<?php /* Smarty version 2.6.9, created on 2021-04-14 12:22:28
         compiled from thanks.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'thanks.html', 79, false),)), $this); ?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html lang="ja">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=Shift_JIS">
<title>日本損害保険協会 - SONPO | 統計･刊行物・報告書 − 刊行物 − お申し込み完了</title>
...
<?php echo '
  ...
  _gaq.push([\'_trackPageview\', \'/archive/publish/form_thanks.html\']);
...
※日本損害保険協会では、発送ならびに集金代行業務については、<br>
「株式会社　マイナビサポート」に委託しております。<br>
...
<?php endif;  if ($this->_tpl_vars['data']['user_status'] == 2): ?>
								<tr>
									...
									<td><table border="0" cellspacing="0" cellpadding="2">
											<tr>
												<td valign="top" class="text2" style="border:none; padding:2px 0 2px 0; width: 85px;">法人・団体名<font class="colorE97">*</font></td>
 ...
 - <?php echo ((is_array($_tmp=$this->_tpl_vars['data']['tel3'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
					...
					<div class="contentBlock1">
						<div class="clearfix">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="archive_list text2">
								<tr>
									<td class="gray02"><strong>刊行物</strong></td>
...
部</td>
  ...
  <?php endforeach; endif; unset($_from);  endforeach; endif; unset($_from); ?>
								...
								<tr>
									<td class="gray02"><strong>料金</strong></td>
<?php if ($this->_tpl_vars['data']['user_status'] == 1): ?>
									<td><table border="0" cellspacing="0" cellpadding="2" width="100%">
											<tr>
...
<?php endif;  if ($this->_tpl_vars['data']['user_status'] == 2): ?><!--法人-->
									<td><table border="0" cellspacing="0" cellpadding="2" width="100%">
											<tr>
												<td valign="top" class="text2" style="border:none; padding:2px;">刊行物代金</td>
												<td class="text2" style="text-align:right; border:none; padding:2px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['total_price'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
円
											...
											<tr>
												<td valign="top" colspan="2" class="text2" style="border:none; padding:2px;">【発送料金について】<br>
　送料は1梱包につき850円（税別）になります。<br>
　冊子の種類（大きさや重量）に応じて梱包数が変動します。　<br>
　なお、送料のご確認については、次の番号までご連絡ください。<br>
<br>
　＜送料確認連絡先＞業務企画部啓発・教育グループ　03-3255-1215<br>
<br>
　＜1梱包（850円：税別）で発送できる部数の目安＞
<table style="margin-left:20px;">
<tr><td class="text2" style="padding:5px; text-align:center; font-weight:bold;">冊子名</td><td class="text2" style="padding:5px; text-align:center; font-weight:bold;">1梱包の最大部数</td></tr>
<tr><td class="text2" style="padding:5px;">ほっと安心ガイド</td><td class="text2" style="padding:5px; text-align:right;">1,500部まで</td></tr>
<tr><td class="text2" style="padding:5px;">ファクトブック</td><td class="text2" style="padding:5px; text-align:right;">50部まで</td></tr>
<tr><td class="text2" style="padding:5px;">小学生のための自転車安全教室</td><td class="text2" style="padding:5px; text-align:right;">200部まで</td></tr>
<tr><td class="text2" style="padding:5px;">知っていますか？自転車の事故</td><td class="text2" style="padding:5px; text-align:right;">300部まで</td></tr>
<tr><td class="text2" style="padding:5px;">飲酒運転防止マニュアル</td><td class="text2" style="padding:5px; text-align:right;">400部まで</td></tr>
</table>
												</td>
											</tr>
										</table></td>
...
<?php if ($this->_tpl_vars['data']['user_status'] == 1): ?>
									<td>郵便代金引換<br><p class="text1">※発送料金には代金引換手数料を含みます。</p></td>
<?php endif;  if ($this->_tpl_vars['data']['user_status'] == 2): ?>
									<td>銀行振り込み<br>※請求書については、刊行物お届けとは<span class="fc-red"><strong>別便</strong></span>でお送りいたします。振り込み手数料は、お客様のご負担となります。</td>
<?php endif; ?>
								</tr>
							</table>
						</div>
