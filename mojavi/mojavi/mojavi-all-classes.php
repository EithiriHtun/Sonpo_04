...
class Controller
{
    ...
    function Controller ($contentType = 'html')
    {
        ...
        $tmp = $this->parseParameters();
        $this->request              = new Request($tmp);
        $this->mojavi               =  array();
    ...
    static function getInstance ($contentType = 'html')
    {
        static $instance;
        if ($instance === NULL)
        {
...
*/
    function removeAttribute ($name, $namespace = 'org.mojavi')
    {
        ...
        if ($namespace !== NULL && isset($namespace[$name]))
        {
            ...
            unset($this->attributes[$org_namespace][$name]);

            if (USE_SESSIONS) {
                unset($_SESSION["attributes"][$org_namespace][$name]);
            }
            return $value;
        }
        return NULL;
    ...
    function setAttribute ($name, $value, $namespace = 'org.mojavi')
    {
        ...
        $this->attributes[$org_namespace] = $namespace;
