...
class HtmlDeleteAction extends DBAction {
  ...
  function execute(&$controller, &$request, &$user){
    ...
    if($user->getAttribute("is_master")){
      ...
      unlink(SONPO_TOPIC_FILE_DIR.$data["open_year"]."/".$article_manager->get_filename($id).'.html');
    ...
    $controller->redirect("/manage/index.php/module/ManageTopic?y=".$data["open_year"]);
    return VIEW_NONE;
  }
