<?php /* Smarty version 2.6.9, created on 2022-03-18 12:56:29
         compiled from pw_reset_request.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'pw_reset_request.html', 26, false),)), $this); ?>
<html>
<head>
...
<form action="/manage/forms/index.php/module/FormManage/action/PasswordRequest" method="POST" target="_top">
<!-- コンテンツ -->
	...
	<tr>
		<td align="center" style="padding:30px 0px 0px 0px;">
			<table border="0" cellpadding="0" cellspacing="0" width="430">
				...
				<tr><td style="padding:10px 0px 0px 4px;"><p class="text2">登録者アカウント名、メールアドレスを入力してください。</p></td></tr>
...
<td class="login_td text2" style="padding-top:4px;"><input type="password" size="100" name="password" style="width:250"></td>
</tr>
<tr>
<th class="login_th text2" style="padding-top:4px;">メールアドレス</th>
<td class="login_td text2" style="padding-top:4px;"><input type="text" size="100" name="email" style="width:250"></td>
</tr>
</table>
...
<div class="botton_frm"><input type="submit" value="ＯＫ"></div>
			...
			<br><br><a href="/manage/forms/">戻る</a>
		</td>
	</tr>
</table>
<!-- /コンテンツ -->
