<?php /* Smarty version 2.6.9, created on 2022-03-09 17:34:44
         compiled from mail/pub_inst_adminmail.txt */ ?>
管理画面から刊行物の申し込みを受け付けました。
お申し込み内容は以下のようになります。
<?php if (@ $this->_tpl_vars['inst_id']): ?>
これは講師派遣からの申込です。
講師派遣受付番号：<?php echo $this->_tpl_vars['inst_id']; ?>
