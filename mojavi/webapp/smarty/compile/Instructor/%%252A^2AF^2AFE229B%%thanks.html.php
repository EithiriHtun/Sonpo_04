...
<title>日本損害保険協会 - SONPO | お役立ち情報 − 講師派遣のご案内 − 入力完了画面</title>
...
<?php echo '
  ...
  _gaq.push([\'_trackPageview\', \'/useful/koushi/moushikomi/form_thanks.html\']);
...
'; ?>
		...
		<div id="main">
			...
			<div id="content">
				<!-- content title -->
				<h2 class="lineCFhead"><span class="text2">お申し込み完了</span></h2>
				...
				<div class="contentBlock1">
					<p class="text2">お申し込みを受け付けました。こちらから御確認の連絡を差し上げます。<br />
お申し込みありがとうございます。</p>
				</div>
				</form>
				<!-- //入力メッセージ -->
				...
				<div class="lineCF"></div>
				<!-- ページの先頭に戻る -->
<!--				<div class="topLink"><p class="text2"><a href="#top" class="totop">トップページに戻る</a></p></div>-->
				<div class="topLink"><p class="text2"><a href="javascript:void(0);" class="totop" onClick="window.close();">閉じる</a></p></div>
				<!-- ページの先頭に戻る -->
			</div>
			<!-- //コンテンツエリア -->
		</div>
