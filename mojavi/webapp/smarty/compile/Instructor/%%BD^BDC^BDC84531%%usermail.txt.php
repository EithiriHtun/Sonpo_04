<?php /* Smarty version 2.6.9, created on 2022-03-08 16:29:01
         compiled from mail/usermail.txt */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'mail/usermail.txt', 40, false),)), $this); ?>
<?php echo $this->_tpl_vars['data']['host']; ?>
　様

損害保険講演会にお申し込みいただき誠にありがとうございます。
お申し込み手続きを<?php echo $this->_tpl_vars['branch_name']; ?>
支部にて承りました。
追って、<?php echo $this->_tpl_vars['branch_name']; ?>
支部からご連絡させていただきます。

受付番号：<?php echo $this->_tpl_vars['inst_id']; ?>


【<?php echo $this->_tpl_vars['branch_name']; ?>
支部　お問合せ先】
　郵便番号：<?php echo $this->_tpl_vars['branch_zip']; ?>

　所在地：<?php echo $this->_tpl_vars['branch_address']; ?>

　電話番号：<?php echo $this->_tpl_vars['branch_tel']; ?>

　FAX番号：<?php echo $this->_tpl_vars['branch_fax']; ?>
